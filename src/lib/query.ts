...
export const FACETS: FacetMeta[] = [
  ...
  { key: "bloomColor", label: "Bloom color", searchable: false, group: "intent", note: "Recorded by USDA — North American species" },
  { key: "bloomPeriod", label: "Bloom period", searchable: false, group: "intent" },
  ...
  { key: "attracts", label: "Attracts", searchable: false, group: "intent", note: "Who visits the flowers — recorded visits, not guesses" },
